...
export const InvestorCard: React.FC<InvestorCardProps> = ({
    ...
    const handleViewProfile = () => {
        navigate(`/profile/investor/${investor.user._id}`);
    };

    const handleMessage = (e: React.MouseEvent) => {
        e.stopPropagation(); // Prevent card click
        navigate(`/chat/${investor.user._id}`);
    };
                ...
                <div className="flex items-start">
                    ...
                    <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-500 mb-2">
                            Investor • {investor.portfolioCompanies.length}{" "}
                            investments
                        </p>
                ...
                <div className="mt-3 flex justify-between items-center">
                    <div>
                        ...
                        <p className="text-sm font-medium text-gray-900">
                            {investor.investmentRange?.minAmount} -{" "}
                            {investor.investmentRange?.maxAmount}
                        </p>
                    </div>
                </div>
            </CardBody>
