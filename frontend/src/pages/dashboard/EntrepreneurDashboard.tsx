...
export const EntrepreneurDashboard: React.FC = () => {
    ...
    const [entrepreneurRequest, setEntrepreneurResquest] = useState<
    ...
    useEffect(() => {
        if (requestsData) {
            setEntrepreneurResquest(requestsData?.requests);
        }
        if (investorData) {
    ...
    const handleRequestStatusUpdate = (
        ...
        setEntrepreneurResquest((prevRequests) =>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 space-y-4">
                    <Card>
                        ...
                        <CardBody>
                            {entrepreneurRequest.length > 0 ? (
                                <div className="space-y-4">
                                    {entrepreneurRequest.map((request) => (
                                ...
                                <div className="text-center py-8">
                                    ...
                                    <p className="text-sm text-gray-500 mt-1">
                                        When investors are interested in your
                                        startup, their requests will appear here
                                    </p>
                                </div>
                            )}
                        </CardBody>
